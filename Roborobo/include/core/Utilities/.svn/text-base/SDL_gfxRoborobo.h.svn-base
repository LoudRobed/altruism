...
void register_Mask( int __x, int __y, std::vector< std::vector<int> > source, SDL_Surface* destination , int __id );
void clean_Mask( int __x, int __y, std::vector< std::vector<int> > source, SDL_Surface* destination ); 
