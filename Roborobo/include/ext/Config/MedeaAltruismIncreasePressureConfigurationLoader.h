/*
 * MedeaAltruismIncreasePressureConfigurationLoader.h
 *
...
#ifndef MEDEAALTRUISMINCREASEPRESSURECONFIGURATIONLOADER_H
#define MEDEAALTRUISMINCREASEPRESSURECONFIGURATIONLOADER_H

#include "Config/ConfigurationLoader.h"


class MedeaAltruismIncreasePressureConfigurationLoader : public ConfigurationLoader
{
	private:

	public:
		MedeaAltruismIncreasePressureConfigurationLoader();
		~MedeaAltruismIncreasePressureConfigurationLoader();
