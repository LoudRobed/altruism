...
#endif
#if defined PRJ_MEDEA_ALTRUISM || !defined MODULAR
	else if (configurationLoaderObjectName == "MedeaAltruismIncreasePressureConfigurationLoader" )
	{
		return new MedeaAltruismIncreasePressureConfigurationLoader();
	}
#endif
#if defined PRJ_MEDEA_ALTRUISM || !defined MODULAR
	else if (configurationLoaderObjectName == "MedeaAltruismBattleConfigurationLoader" )
	{
		return new MedeaAltruismBattleConfigurationLoader();
	}
#endif
...
//	}
	...
	else if (configurationLoaderObjectName == "BasicProjectKilobotConfigurationLoader" )
	{
		return new BasicProjectKilobotConfigurationLoader();
	}
#endif
#if defined PRJ_BASICPROJECT_AGGREGATION || !defined MODULAR
	else if (configurationLoaderObjectName == "BasicProjectAggregationConfigurationLoader" )
	{
		return new BasicProjectAggregationConfigurationLoader();
	}
#endif
#if defined PRJ_MEDEA_AGGREGATION || !defined MODULAR
	else if (configurationLoaderObjectName == "MedeaAggregationConfigurationLoader" )
	{
		return new MedeaAggregationConfigurationLoader();
	}
	else if (configurationLoaderObjectName == "MedeaAggregationBattleConfigurationLoader" )
	{
		return new MedeaAggregationBattleConfigurationLoader();
	}
#endif
	else
	{
