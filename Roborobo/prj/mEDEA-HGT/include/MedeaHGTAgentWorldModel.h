...
#ifndef MEDEAHGTEVOLVINGROBOTAGENTWORLDMODEL_H
#define MEDEAHGTEVOLVINGROBOTAGENTWORLDMODEL_H
...
class MedeaHGTAgentWorldModel : public EvolvingRobotAgentWorldModel
{
	protected:
		...
		int _encounteredAgentsDuringGeneration;


	public:
		//Initializes the variables
		MedeaHGTAgentWorldModel();
		~MedeaHGTAgentWorldModel();
		...
		void setEncounteredAgentsDuringGeneration(int encounteredAgentsDuringGeneration);
		int getEncounteredAgentsDuringGeneration();
