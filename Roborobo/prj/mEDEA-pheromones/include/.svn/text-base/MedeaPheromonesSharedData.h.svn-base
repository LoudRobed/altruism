...
#ifndef MEDEAPHEROMONESSHAREDDATA_H
#define MEDEAPHEROMONESSHAREDDATA_H

class MedeaPheromonesSharedData {
...
//	static int gMaxEvaluation; //! how long a controller will be evaluated on a robot UNUSED
	...
	static bool gDynamicRespawn; //! if true, ignore gEnergyPointRespawnLagMaxValue and use tailored MedeaPheromones update version.
