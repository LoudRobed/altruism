/*
 *  MedeaAltruismReplayPartialEvoAgentWorldModel.h
 *  roborobo-online
 *
...
#ifndef MedeaAltruismReplayPartialEvoAGENTWORLDMODEL_H
#define MedeaAltruismReplayPartialEvoAGENTWORLDMODEL_H 
...
class MedeaAltruismReplayPartialEvoAgentWorldModel : public EvolvingRobotAgentWorldModel
{
	protected:
	...
	public:
		MedeaAltruismReplayPartialEvoAgentWorldModel();
		~MedeaAltruismReplayPartialEvoAgentWorldModel();
		...
		void setPrevX (double inPrevX);
		double getPrevX ();

		void setPrevY (double inPrevY);
		double getPrevY ();
