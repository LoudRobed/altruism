/*
 *  MedeaOptimSharedData.h
 *
 *  Created by Nicolas on 19/1/2011
 *
 */

#ifndef MedeaOptimOPTIMSHAREDDATA_H
#define MedeaOptimOPTIMSHAREDDATA_H

class MedeaOptimSharedData {
...
//	static int gMaxEvaluation; // how long a controller will be evaluated on a robot UNUSED
	...
	static bool gDynamicRespawn; // if true, ignore gEnergyPointRespawnLagMaxValue and use tailored Medea update version.

	static double gAlphaCorrelationValue; // the correlation value btw used-defined objective and surviving. (medea:optim project)
