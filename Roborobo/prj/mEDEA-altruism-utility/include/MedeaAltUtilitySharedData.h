...
#ifndef MEDEAALTUTILITYSHAREDDATA_H
#define MEDEAALTUTILITYSHAREDDATA_H

class MedeaAltUtilitySharedData {
...
//	static int gMaxEvaluation; // how long a controller will be evaluated on a robot UNUSED
	...
	static bool gDynamicRespawn; // if true, ignore gEnergyPointRespawnLagMaxValue and use tailored MedeaAltUtility update version.
