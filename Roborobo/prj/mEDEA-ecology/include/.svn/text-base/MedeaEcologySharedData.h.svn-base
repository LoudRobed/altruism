...
#ifndef MEDEAECOLOGYSHAREDDATA_H
#define MEDEAECOLOGYSHAREDDATA_H

class MedeaEcologySharedData {
...
//	static int gMaxEvaluation; //! how long a controller will be evaluated on a robot UNUSED
	...
	static bool gDynamicRespawn; //! if true, ignore gEnergyPointRespawnLagMaxValue and use tailored MedeaEcology update version.
