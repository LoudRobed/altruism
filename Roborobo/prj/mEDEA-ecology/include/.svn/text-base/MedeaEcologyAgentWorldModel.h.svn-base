...
#ifndef MEDEAECOLOGYAGENTWORLDMODEL_H
#define MEDEAECOLOGYAGENTWORLDMODEL_H
...
class MedeaEcologyAgentWorldModel : public EvolvingRobotAgentWorldModel
{
	protected:
